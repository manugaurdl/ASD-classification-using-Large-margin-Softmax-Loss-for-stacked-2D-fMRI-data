...
def collect_and_download(derivative, pipeline, strategy, out_dir):
    ...
    s3_pheno_file = open("/content/drive/MyDrive/ABIDE_NYU/phenotypes/Phenotypic_V1_0b_preprocessed1.csv", "r")
...
if __name__ == "__main__":
    ...
    derivatives = ["func_mean"]
    pipeline = "ccs"
    strategy = "filt_global"

    out_dir = os.path.abspath("/content/drive/MyDrive/func_mean")
